    ...
    !dismissed && (
      <div className="overflow-hidden bg-white dark:-mb-32 dark:mt-[-4.5rem] dark:bg-slate-900 dark:pb-32 dark:pt-[4.5rem] dark:lg:mt-[-4.75rem] dark:lg:pt-[4.75rem]">
        <div className="pb-10 lg:relative lg:px-0">
          <div className="mx-auto grid max-w-2xl grid-cols-1 items-center gap-y-16 gap-x-8 px-0 lg:max-w-8xl lg:grid-cols-2 xl:gap-x-16">
            <div className="relative z-10 flex flex-col gap-y-3 md:text-center lg:text-left">
              ...
              <div className="relative">
                ...
                <div className="mt-8 flex gap-4 md:justify-center lg:justify-start">
                  <Button
                    href="https://ycodify.com/register"
                    variant="secondary"
                  >
                    Try out
                  </Button>
            ...
            <div className="relative lg:static xl:pl-10">
              ...
              <div className="relative">
                ...
                <div className="relative rounded-2xl bg-[#0A101F]/80 ring-1 ring-sky-400 backdrop-blur dark:ring-white/10">
                  ...
                  <div className="pt-4 pl-4">
                    ...
                    <div className="mt-6 flex items-start px-1 text-sm">
                      <div
                        aria-hidden="true"
                        className="select-none border-r border-slate-300/5 pr-4 font-mono text-slate-400 dark:text-slate-500"
                      >
                        {Array.from({
                          length: code2.split('\n').length,
                        }).map((_, index) => (
